 ...
 *
 * Прим: мы не можем использовать классы движка из kira\db\, потому что там параметры подключения читаются из
 * конфига приложения, а у нас его еще нет. Поэтому в этой модели своя обертка для PDO.
 *
 * TODO Можно ли это улучшить:
 *
 * Явное неудобство в том, что нужно отдельно вызывать метод соединения с базой и передавать в него конфиг соединения.
